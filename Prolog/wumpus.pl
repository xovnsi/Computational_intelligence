...
# The position of gold is also drawn with equal probability, and it too cannot be on the field with coordinates (1,1).
...
permitted([X,Y]) :-
    ...
    adjacent([X1,Y1],[X,Y])). % Checking needed! Neighbour of agent_location
